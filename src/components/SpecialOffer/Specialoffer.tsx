    ...
    return (
        <div className="bg-[#fffbf2] md:flex justify-evenly my-16 md:p-10 mx-3 overflow-x-hidden gap-4">
            <section className="mt-32 mb-12">
                ...
                <button
                    type="button"
                    className="bg-[#fcc522] flex px-8 p-2.5 text-xl text-white items-center gap-5"
                    style={{ height: '60px', borderRadius: '20px' }}
                >
                    See All Menu
                    <span
                        className="bg-white flex justify-center items-center text-3xl font-black text-black"
            ...
            <section className="relative flex justify-center mt-12">
                <Image
                    src="https://media.istockphoto.com/id/646771262/photo/tuna-steaks-asian-style.jpg?s=612x612&w=0&k=20&c=_GZ6_oo_kBsZ3hWPVRrTyOetmZzfHByJwcvPR5oiop0="
                    alt="Tuna Steaks"
                ...
                />
                <div
                    className="shadow-lg flex gap-5 absolute bg-white rounded-xl p-5 items-center"
                    style={{
                        left: '-100px',
                        top: '-40px',
                        width: '350px',
