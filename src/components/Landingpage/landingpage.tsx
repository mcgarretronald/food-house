    ...
    return (
        <div className="flex flex-col lg:flex-row justify-between md:mx-20 md:mt-6 mx-3 lg:my-20">
            <section className="lg:mt-20">
                ...
                <button
                    type="button"
                    className="text-white bg-[#fcc522] hover:bg-[#e6b71d] focus:ring-4 focus:outline-none focus:ring-[#fcc522] font-medium rounded-lg text-lg px-5 py-2.5 mb-12 md:mx-0"
                >
                    ORDER NOW
                </button>
            </section>
